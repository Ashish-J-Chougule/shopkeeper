...
class ComicsControllerTest < ActionController::TestCase
  ...
  test "should create comic" do
    assert_difference('Comic.count') do
      post :create, comic: { author: @comic.author, description: @comic.description, price: @comic.price, rating: @comic.rating, title: @comic.title }
    end
  ...
  test "should update comic" do
    patch :update, id: @comic, comic: { author: @comic.author, description: @comic.description, price: @comic.price, rating: @comic.rating, title: @comic.title }
    assert_redirected_to comic_path(assigns(:comic))
  end
